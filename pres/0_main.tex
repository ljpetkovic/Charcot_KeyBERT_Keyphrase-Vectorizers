...
\date[DataLab, le 24 avril 2024]{\scriptsize  Atelier \textsc{ObTIC}\\DataLab, \textsc{BnF}\\Paris, le 24 avril 2024}
\usepackage{YTU}
...
\input{sota}
\section[\textit{PatternRank}]{\textit{PatternRank} en pratique}
\input{patternrank}
